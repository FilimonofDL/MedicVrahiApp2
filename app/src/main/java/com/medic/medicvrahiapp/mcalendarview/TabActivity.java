...
public class TabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.calendar_view_activity_tab);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.calendar_view_fragment_tab, container, false);

            mPageTitleTv = (TextView) rootView.findViewById(R.id.tab_activity_page_title);
            mPageTitleTv.setText("Page: "+getArguments().getInt(ARG_SECTION_NUMBER)+"　　page");
            ...
            YearMonthTv.setText(Calendar.getInstance().get(Calendar.YEAR) + " G " + (Calendar.getInstance().get(Calendar.MONTH) + 1) + " D ");
...
//                    YearMonthTv.setText(String.format("%d Y %d D", year, month));
                }
